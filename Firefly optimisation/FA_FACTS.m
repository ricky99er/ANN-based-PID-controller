...
% % %  hold on;plot(ckb,b1,'b');hold on;plot(ckb1,b11,'r');xlabel('Time(s)'),ylabel('\Delta-f1')
% % % hold on;plot(ckb,b2,'b');hold on;plot(ckb1,b12,'r');xlabel('Time(s)'),ylabel('\Delta-f2')
% % % hold on;plot(ckb,b3,'b');hold on;plot(ckb1,b13,'r');xlabel('Time(s)'),ylabel('\Delta-f3')
% % % hold on;plot(ckb,b7,'b');hold on;plot(ckb1,b17,'r');xlabel('Time(s)'),ylabel('\Delta-Ptie1')
% % % hold on;plot(ckb,b8,'b');hold on;plot(ckb1,b18,'r');xlabel('Time(s)'),ylabel('\Delta-Ptie2')
% % % hold on;plot(ckb,b9,'b');hold
% on;plot(ckb1,b19,'r');xlabel('Time(s)'),ylabel('\Delta-Ptie3')
...
para=[4 20 0.5 0.2 0.1];
rand('seed',10200);
help fa_mincon.m
% This demouses the Firefly Algorithm to solve the
...
% Ub=[ 1 1 1 100 1 1 1 100 1 1 1 100 1 1 1 100 1 1 1 100];
Lb=[ 0 0 0 0 ];
Ub=[ 2 2 2 100];
...
%% Cost or Objective function
 function z=cost(x)
        ...
        simulationoptions=simset('srcworkspace','current');
        [t,y]=sim('ANN_02',[0 100],simulationoptions);
        s=length(ISE);
        z=ISE(s)
...
if nargin<6, para=[5 50 0.25 0.20 1]; end
if nargin<5, Ub=[]; end
if nargin<4, Lb=[]; end
if nargin<3,
